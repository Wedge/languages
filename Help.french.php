...
$helptxt['primary_membergroup'] = '
	...
	Puisque la modération est définie indépendamment pour chaque section, et que le groupe Modérateurs est de type virtuel, vous devrez assigner les membres en tant que modérateurs à partir de <a href="javascript:window.open(\'%1$s?action=admin;area=manageboards\'); self.close();">l\'interface de gestion des sections</a>.';
