...
$helptxt['mail_from'] = 'Nous vous recommandons fortement de spécifier ici une adresse e-mail spécifique qui sera utilisée dans le champ "expéditeur" de tous les e-mails sortants (notifications, info-lettres, etc).
