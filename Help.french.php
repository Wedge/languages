...
$helptxt['disableTemplateEval'] = 'Par défaut, les modèles de thème sont simplement inclus au lieu d\'être évalués. L\'évaluation permet d\'afficher plus d\'informations en cas d\'erreur du traitement.<br><br>Toutefois, sur des forums de grande taille, ce processus peut ralentir sensiblement le traitement. Il leur est donc recommandé de le laisser désactivé.';
...
$helptxt['default_timezone'] = 'La zone horaire indique à PHP où se trouve le serveur du site. Assurez-vous que ladite zone soit correctement renseignée, notamment le pays voire la ville. Vous trouverez plus d\'informations sur <a href="http://www.php.net/manual/fr/timezones.php" target="_blank">le site de PHP</a>.';
...
$helptxt['ignorable_boards'] = 'Cette option permet aux utilisateurs de marquer des sections comme étant à ignorer. Une section ignorée est considérée comme étant toujours "lue" en consultant la liste des sections, et les sujets qu\'elle contient n\'apparaîtront pas dans les pages Messages récents, Messages non lus et Réponses non lues.';
