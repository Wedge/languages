...
$helptxt['pruneSavedDrafts'] = 'Drafts saved on the server do not have any normal limits, but the administrator can use this option to automatically clean out old drafts of users to keep the database smaller. If this is set to a number, any drafts older than the number of days given will be removed. If set to 0, drafts are always kept until the author decides to delete them from their profile.';
...
$helptxt['latest_packages'] = 'Here you can see some of the most popular and some random add-ons, with quick and easy installations.<br /><br />If this section doesn\'t show up, your computer probably cannot connect to <a href="http://www.simplemachines.org/" target="_blank" class="new_win">www.simplemachines.org</a>.';
