...
$txt['media_zoom_outline_info'] = 'Defines the type of outline to display around the expanded content. <i>drop-shadow</i> just retains the drop shadow. <i>black</i> and <i>white</i> add a frame on top of it, while <i>glass</i> applies a gradient glass effect.';
