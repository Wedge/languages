...
$txt['media_zoom_outline_info'] = 'Defines the type of outline to display around the expanded content. <i>black</i> and <i>white</i> have a frame with drop shadow, while <i>drop-shadow</i> does without the frame.';
