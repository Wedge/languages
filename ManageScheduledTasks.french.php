...
$txt['scheduled_task_fetchRemoteFiles'] = 'Télécharger les fichiers de Wedge.org';
$txt['scheduled_task_desc_fetchRemoteFiles'] = 'Télécharge les fichiers JavaScript sur le site officiel, contenant des notifications de mise à jour et autres informations.';
