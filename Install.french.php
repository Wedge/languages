...
$txt['install_settings_compress_info'] = 'Cette fonction ne fonctionne pas sur tous les serveurs, mais peut contribuer à économiser énormément la bande passante.<br>Cliquez <a href="install.php?obgz=1&amp;pass_string=REUSSI" onclick="window.event = event; return reqWin(this, 200, 80);" target="_blank">ici</a> pour tester. Si le lien vous répond "REUSSI", c\'est que c\'est bon.';
