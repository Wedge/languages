...
$txt['install_welcome_desc'] = 'Bienvenue sur Wedge. Ce script vous aidera à installer %1$s. Nous allons vous demander des détails sur votre forum dans les pages à venir, et il sera prêt à être utilisé en quelques minutes à peine.';
...
$txt['default_recycling_board_name'] = 'Corbeille';
...
$txt['default_cheesy_smiley'] = 'Grand sourire';
$txt['default_grin_smiley'] = 'Gnéhé';
...
$txt['default_roll_eyes_smiley'] = 'Tss...';
$txt['default_tongue_smiley'] = 'Hihi';
$txt['default_embarrassed_smiley'] = 'Embarrassé';
$txt['default_lips_sealed_smiley'] = 'Bouche cousue';
$txt['default_undecided_smiley'] = 'Indécis';
$txt['default_kiss_smiley'] = 'Bises';
$txt['default_cry_smiley'] = 'Snif';
$txt['default_evil_smiley'] = 'Diabolique';
$txt['default_azn_smiley'] = 'Sourire d\'Asie';
$txt['default_afro_smiley'] = 'Afro';
$txt['default_laugh_smiley'] = 'Mort de rire';
$txt['default_police_smiley'] = 'Police';
$txt['default_angel_smiley'] = 'Ange';
$txt['default_edit_smiley'] = 'Modifié';
...
$txt['install_settings_name_info'] = 'C\'est le nom que portera votre forum, par exemple "Forum du site".';
...
$txt['db_settings_database_info'] = 'Indiquez le nom de la base de données que vous voulez utiliser pour stocker des données de Wedge.';
...
$txt['user_settings_username_info'] = 'Choisissez l\'identifiant (nom d\'utilisateur) avec lequel vous désirez vous connecter.';
...
$txt['ftp_setup_why_info'] = 'Certains fichiers nécessitent d\'être accessibles en écriture par Wedge pour que votre forum fonctionne correctement. Cette étape permet à l\'installateur de régler ces propriétés pour vous. Toutefois, dans certains cas, ça ne fonctionnera pas - auquel cas veuillez faire un chmod 777 (écriture possible, 755 chez certains hébergeurs) sur les fichiers suivants&#8239;:';
$txt['ftp_setup_again'] = 'pour vérifier si les fichiers sont de nouveaux accessibles en écriture.';

$txt['error_php_too_low'] = 'Attention&#8239;! Il semblerait que votre serveur ne contienne pas une version de PHP compatible avec <strong>les exigeances minimales requises</strong> de Wedge.<br>Si vous n\'êtes pas votre propre hébergeur, vous devrez lui demander d\'effectuer une mise à jour, ou changer d\'hébergeur. Autrement, veuillez mettre à jour PHP vers une version plus récente.<br><br>Si vous êtes sûr que votre version de PHP est assez récente, vous pouvez continuer, mais c\'est fortement déconseillé.';
$txt['error_pcre_too_low'] = 'Attention&#8239;! Il semblerait que votre serveur ne contienne pas une version de la librairie PCRE (Perl-Compatible Regular Expressions) compatible avec <strong>les exigeances minimales requises</strong> de Wedge.<br>Si vous n\'êtes pas votre propre hébergeur, vous devrez lui demander d\'effectuer une mise à jour, ou changer d\'hébergeur. Autrement, veuillez mettre à jour PCRE vers une version plus récente.<br><br>Si vous êtes sûr que votre version de PCRE est assez récente, vous pouvez continuer, mais c\'est fortement déconseillé.';
...
$txt['error_no_sxml'] = 'Votre serveur n\'a pas activé la fonction SimpleXML, et plusieurs fonctionnalités de Wedge ont besoin de cette extension PHP.<br><br>Vous devez installer SimpleXML avant de pouvoir continuer. Si vous ne pouvez pas l\'installer vous-même, demandez à votre hébergeur, ou changez d\'hébergeur. Sinon, installez et/ou configurez SimpleXML pour utilisation avec PHP.';
$txt['error_windows_chmod'] = 'Vous êtes sous un serveur Windows, et quelques fichiers cruciaux ne sont pas accessibles en écriture. Veuillez contacter votre hébergeur afin qu\'il donne des <strong>permissions d\'écritures</strong> à l\'utilisateur sur lequel PHP fonctionne pour les fichiers de votre installation de Wedge. Les fichiers ou dossiers suivants doivent être accessibles en écriture&#8239;:';
...
$txt['error_db_too_low'] = 'La version de votre serveur de base de données (%1$s) est très ancienne, et ne répond pas aux besoins de Wedge.<br><br>Veuillez contacter votre hébergeur pour qu\'il le mette à jour ou vous en fournisse un nouveau, et s\'il ne veut pas, essayez chez un autre hébergeur.';
$txt['error_db_database'] = 'L\'installateur a été incapable d\'accéder à la base de données &quot;<em>%1$s</em>&quot;. Avec certains hébergeurs, vous devez créer la base de données dans votre panneau administrateur avant que Wedge ne puisse l\'utiliser. Certains aussi ajoutent des préfixes - comme votre nom d\'utilisateur - aux noms de vos bases de données.';
...
$txt['error_db_missing'] = 'L\'installateur a n\'a pas pu détecter de support pour les bases de données dans PHP. Veuillez demander à votre hébergeur de s\'assurer que PHP a été compilé avec les bases de données désirées, ou que l\'extension <strong>mysqli</strong> (MySQL Improved) associée a bien été chargée.';
...
$txt['error_already_installed'] = 'L\'installateur a détecté que Wedge est déjà installé. Le processus s\'est arrêté, pour éviter d\'effacer vos données existantes.<br><br>Si vous voulez remettre votre forum à zéro et écraser votre installation existante, y compris toutes ses données, effacez manuellement les tables de la base de données, remplacez le fichier Settings.php et réessayez.';
