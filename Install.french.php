...
$txt['error_no_libxml'] = 'Attention&nbsp;! Il semblerait que libxml ne soit pas installé sur votre serveur. Cette extension d\'Apache, installée d\'ordinaire par défaut, est requise par Wedge. Une fois que vous aurez installé ce module, vous pourrez reprendre l\'installation. Demandez à votre hébergeur si vous ne pouvez pas le faire vous-même, ou changez de serveur ou d\'hébergeur.';
