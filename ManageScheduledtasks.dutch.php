...
$txt['scheduled_tasks_time_offset'] = '<strong>Opm:</strong> alle hieronder genoemde tijden zijn in <em>servertijd</em>, waarin geen rekening wordt gehouden met tijdsafwijkingen die in je account ingesteld zijn.';
...
$txt['scheduled_task_fetchRemoteFiles'] = 'Ophalen externe bestanden Wedge ';
$txt['scheduled_task_desc_fetchRemoteFiles'] = 'Ophalen JavaScript-bestanden  van de officiële website, met berichten over updates en andere informatie.';
