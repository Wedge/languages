...
$txt['mc_description'] = 'This is your &quot;Moderation Center&quot;. From here you can perform all the moderation actions assigned to yourself by the Administrator. This home page contains a summary of all the latest happenings in your community. You can personalize the layout by clicking <a href="<we:scripturl>?action=moderate;area=settings">here</a>.';
...
$txt['mc_latest_news'] = 'Wedge Latest News';
$txt['mc_recent_reports'] = 'Recent Topic Reports';
$txt['mc_warnings'] = 'Warnings';
$txt['mc_notes'] = 'Moderator Notes';

$txt['mc_cannot_connect_sm'] = 'Unable to connect to wedge.org\'s latest news file.';
...
$txt['mc_warning_template_desc'] = 'Use this page to fill in the details of the template. Note that the subject for the email is not part of the template. Also, as the notification is sent by PM, you can use BBC within the template. Finally, if you use the {MESSAGE} variable, then this template will not be available when issuing a generic warning (i.e. not linked to a post.)';
...
$txt['mc_prefs_latest_news'] = 'Wedge News';
