...
$txt['paid_email_to_desc'] = 'Список адресов, разделенных запятыми — на эти адреса будут рассылаться уведомления.';
...
$txt['paid_allowed_groups'] = 'Группы, которым разрешено покупать эту подписку';
$txt['paid_allowed_groups_desc'] = 'Это позволяет вам выбирать группы, разрешенные для покупки этой подписки (специальные подписки для повторных подписчиков).';
...
$txt['paid_note'] = '<strong class="alert">Примечание:</strong><br>Для автоматически продляемых подписок необходимо установить адрес возвращения для каждого из способов оплаты. Для всех типов оплаты этот URL-адрес должен быть задан как:<br><br>
	...
	Для других шлюзов (если они установлены) нужный адрес можно найти в панели клиента — обычно это пункты &quot;Return URL&quot; (&quot;Возвращаемый URL&quot;) или &quot;Callback URL&quot; (&quot;Обратный URL&quot;).';
...
$txt['paid_mod_span_lifetime'] = 'Продолжительность';
$txt['paid_mod_span_lifetime_expires'] = 'Никогда';
...
$txt['paid_mod_allow_partial_desc'] = 'Если эта опция включена и пользователь меньше, чем нужно — ему будет предоставлена подписка на оплаченный период времени.';
...
$txt['flexible'] = 'Гибкая';
$txt['paid_mod_lifetime_price'] = 'Подписка является разовым платежом';
...
$txt['paypal_unverified'] = 'PayPal: непроверенная транзакция.';
$txt['paypal_incorrect_email'] = 'PayPal: неверное значение электронного адреса.';
$txt['paypal_invalid_currency'] = 'PayPal: неверная валюта.';
$txt['paypal_no_item'] = 'PayPal: элемент не был возвращен.';
...
$txt['paid_subs_admin_override'] = 'Этот пользователь не входит ни в одну из групп, которым разрешено заказывать эту подписку.';
