...
$txt['error_pcre_too_low'] = 'Warning! Your PHP install is currently using a version old version of the PCRE (Perl-Compatible Regular Expressions) engine. As Wedge makes strong use of complex regular expressions, you must meet its <strong>minimum installations requirements</strong>.<br>If you are not the host, you will need to ask your host to upgrade, or use a different host - otherwise, please upgrade your PCRE library to a recent version.<br><br>If you know for a fact that your PCRE version is high enough you may continue, although this is strongly discouraged.';
