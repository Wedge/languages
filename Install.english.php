...
$txt['install_settings_compress_info'] = 'This function does not work properly on all servers, but can save you a lot of bandwidth.<br>Click <a href="install.php?obgz=1&amp;pass_string=PASS" onclick="return reqWin(this, 200, 60);" target="_blank">here</a> to test it. (it should just say "PASS".)';
...
$txt['db_settings_database_file_info'] = 'This is the name of the file in which to store the Wedge data. We recommend you use the randomly generated name for this and set the path of this file to be outside of the public area of your webserver.';
...
$txt['error_no_libxml'] = 'Warning! You do not appear to have libxml installed on your server. It is required by Wedge, and is normally installed as a default Apache module. Do not proceed until libxml is installed. Contact your host if you can\'t install it yourself, or use a different server/host.';
...
$txt['error_db_too_low'] = 'The version of your database server is very old, and does not meet Wedge\'s minimum requirements.<br><br>Please ask your host to either upgrade it or supply a new one, and if they won\'t, please try a different host.';
...
$txt['error_versions_do_not_match'] = 'The installer has detected another version of Wedge already installed with the specified information. If you are trying to upgrade, you should use the upgrader, not the installer.<br><br>Otherwise, you may wish to use different information, or create a backup and then delete the data currently in the database.';
