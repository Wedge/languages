...
$txt['addon_manager_desc'] = 'Below is a list of all the add-ons currently on the server.';

$txt['fatal_not_valid_addon'] = 'The specified add-on cannot be installed because it appears to be missing or damaged.';
