...
$txt['fatal_install_error_minphp'] = 'This add-on cannot be installed, it requires PHP version %1$s, but this server only has version %2$s installed.';
$txt['install_error_minmysql'] = 'MySQL version %1$s is required (%2$s available)';
$txt['fatal_install_error_minmysql'] = 'This add-on cannot be installed, it requires MySQL version %1$s, but this server only has version %2$s installed.';
...
$txt['fatal_install_remove_missing'] =  'This add-on specifies that a certain file contains instructions to be carried out when removing it, %1$s, but the file cannot be found where the add-on said it should be.';
