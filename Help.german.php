...
$helptxt['ban_gmail_style'] = 'Google Mail, oder GMail, bieten ihren Mitgliedern einige Bequemlichkeiten, ihre Mailkonten zu verwalten.
...
$helptxt['no_hostname_ban'] = 'Die Suche nach Hostnamen wurde deaktiviert. Damit werden auch alle Sperren auf Hostnamen deaktiviert.';

$helptxt['ban_email_types'] = 'Emails können auf unterschiedliche Art und Weise gesperrt werden.
	<ul class="normallist">
...
$helptxt['ban_membername_style'] = 'Bei der Sperre, oder Bestrafung von Mitgliedernamen, kann die Sperre nur auf den Benutzernamen, oder den angezeigten Namen angewendet werden. Da Benutzer ihren angezeigten Namen verändern können,
...
$helptxt['login_type'] = 'Dieser Bereich ermöglicht es dir zu bestimmen, ob Mitglieder sich mit dem Benutzernamen, der Emailadresse oder beidem anmelden können.';
...
$helptxt['allow_guestAccess'] = 'Sollte diese Option deaktiviert sein, können Gäste nur noch rudimentäre Funktionen des Forums verwenden (Einloggen, Registrieren, Passworterinnerung etc.). Die Option hat nicht die gleichen Auswirkungen wie Gästen den Zugriff auf die Foren zu verbieten.';
$helptxt['userLanguage'] = 'Ermöglicht dem Benutzer die Auswahl einer individuellen Sprache im Forum. Wirkt sich nicht auf die Standardeinstellung aus.';
$helptxt['availableLanguage'] = 'Diese Funktion legt fest, ob Benutzer ihre eigene Sprache wählern können. Sprachen können zwar installiert sein, aber stehen nicht unbedingt zur Wahl für die Benutzer.';
$helptxt['trackStats'] = 'Statistiken aktivieren:<br />Erlaubt den Benutzern verschiedene Statistiken zu sehen, z.B. die neuesten Einträge, die meistbesuchten Themen, die neuesten Themen und vieles mehr.<hr />
		Seitenaufrufe zählen:<br />Fügt den Statistiken eine weitere Spalte mit den Seitenaufrufen des Forums hinzu.';
$helptxt['titlesEnable'] = 'Diese Option erlaubt den Mitgliedern, sich einen frei wählbaren Titel zu geben, welcher unter dem Namen angezeigt wird.<br />
<i>Beispiel:</i><br />Nao<br />Herr der Augenringe';
$helptxt['todayMod'] = 'Zeigt "Heute" und/oder "Gestern" statt des Datums an.<br /><br />
...
$helptxt['enablePreviousNext'] = 'Zeigt einen Link zum nächsten bzw. vorherigen Betrag an.';
$helptxt['ignoreMoveVsNew'] = 'Standardmäßig wird dem Benutzer beim verschieben von Themen eine Auswahl an Foren angeboten, in der er diese Beiträge verschieben kann, mit Ausnahme von Ankündigungsforen, etc.
...
$helptxt['webmaster_email'] = 'Legt die Emailadresse des Administrators fest, an welche Benachrichtigungen über Datenbankfehler, etc. gesendet werden. Daher sollte diese Adresse auch wirklich gültig sein.';
$helptxt['mail_from'] = 'Erlaubt die Einstellung der Absenderadresse der verschickten Emails (Benachrichtigungen, Newsletter, etc.)
...
$helptxt['enableCompressedData'] = 'Diese Funktion aktiviert die komprimierte Übertragung von CSS und JS Dateien im gzip-Format nach dem cachen. Diese Funktion erfordert ein installiertes zlib auf dem Server.
		Es wird ebenfalls eine korrekt konfigurierte .htaccess Datei erwartet.';
$helptxt['obfuscate_filenames'] = 'Diese Funktion verschleiert die Dateinamen von JavaScript und CSS Dateien.
		Diese Funktion soll es Scriptdieben erschweren, die Dateien zu klauen.';
$helptxt['minify'] = 'Diese Funktion minimiert JavaScript Dateien "on the fly". Wenn diese Funktion aktiviert ist, werden alle Leerzeichen und Kommentare aus den Dateien entfernt.
...
$helptxt['jquery_origin'] = 'Diese Einstellung ermöglicht die Auswahl der Server, über die jQuery ausgeliefert werden soll. Wenn du Bandbreite sparen möchtest,
...
$helptxt['disableTemplateEval'] = 'Standardmäßig werden Vorlagen (Templates) verarbeitet statt nur inkludiert. Dieses hilft dabei, Debug Informationen anzuzeigen, wenn das Template einen Fehler enthält.<br/>
<br/>
...
$helptxt['db_show_debug'] = 'Aktiviert das Debugging für Abfragen. Sehr nützlich, wenn man Fehler finden möchte. Die Ausgabe erscheint unterhalb der Seite, wenn diese FUnktion aktiviert ist<br><br>
...
$helptxt['db_show_debug_who'] = 'Diese Debug-Information ist sehr nützlich, wenn es kleine Fehler im Forum gibt. Diese Funktion ist aber für die meisten Mitglieder nicht relevant.
		Diese Funktion ermöglicht es einzustellen, wer diese Meldungen zu sehen bekommt, wenn diese Funktion aktiviert ist.';
$helptxt['db_show_debug_who_log'] = 'Teil dieser Debug-Informationen ist die Ausgabe von jeder Datenbankabfrage, die dieses Forum im Betrieb ausübt. 
...
$helptxt['databaseSession_enable'] = 'Verwendet die Datenbank zum Speichern von Sitzungen und ist das Beste für eine ausgeglichene Last des Servers. Die Option hilft bei den sogenannten Timeouts und macht das Forum unter Umständen schneller.';
$helptxt['databaseSession_loose'] = 'Reduziert die Bandbreite des Forums, jedoch wird bei einem Klick auf den Zurück-Button im Browser die vorherige Seite nicht neu geladen. Neue Beiträge, Symbole und andere Werte werden daher nicht aktualisiert.';
$helptxt['databaseSession_lifetime'] = 'Anzahl der Sekunden für die Länge einer Datenbanksitzung. Sollte eine Sitzung eine Zeit lang nicht genutzt werden, wird sie als "verloren gegangen" bezeichnet. Empfohlen wird mindestens der Wert 2400.';
$helptxt['enableErrorLogging'] = 'Erfasst alle Fehlermeldungen im Forum (z.B. fehlerhafte Anmeldung etc.).';
$helptxt['enableErrorQueryLogging'] = 'Diese Option fügt die komplette Datenbankabfrage in das Fehlerprotokoll ein. Dazu muss das protokollieren von Fehlern aktiviert sein.<br /><br /><strong>Achtung: Damit geht die Möglichkeit verloren, das Fehlerprotokoll nach Fehlermeldungen zu filtern.';
...
$helptxt['disallow_sendBody'] = 'Verhindert das Versenden von Text mit Antworten oder neuen Beiträgen in den Benachrichtigungs-Emails.<br /><br />Oftmals antworten Mitglieder fälschlicherweise auf diese Emails, so dass der Webmaster eine Flut an E-Mails erhält.';
$helptxt['timeLoadPageEnable'] = 'Zeigt am unteren Bildschirmrand die Zeit in Sekunden an, die Wedge für das Erstellen der Seite benötigt hat.';
$helptxt['removeNestedQuotes'] = 'Dies wird alle verschachtelten Zitate eines Beitrags entfernen, wenn man einen solchen Beitrag über den entsprechenden Link zitiert.';
$helptxt['max_image_width'] = 'Erlaubt die Angabe einer maximalen Breite von Bildern. Bilder die kleiner sind, werden dadurch nicht beeinträchtigt.';
...
$helptxt['attachment_image_paranoid'] = 'Diese Funktion führt Prüfungen für Bilder nach sehr strengen Vorgaben durch. Warnung! Die Prüfungen können manchmal auch gültige Bilder zurückweisen. Es wird dringend empfohlen, diese Funktion nur im Zusammenhang mit der Neucodierung von Dateien zu verwenden. Dabei versucht Wedge das beschädigte Bild neu zu erstellen. Sollte der Versuch fehlschlagen, wird das Bild zurückgewiesen.';
$helptxt['attachment_image_reencode'] = 'Diese Funktion versucht hochgeladene Bilddateien neu zu codieren. Das Neucodieren von Bilddateien ist eine sehr effinziente Sicherheitsmaßnahme. Beachte: alle animierten Bilder, die neu codiert wurden sind dann statisch!';
$helptxt['avatar_paranoid'] = 'Diese Funktion führt Prüfungen für Benutzerbilder nach sehr strengen Vorgaben durch. Warnung! Die Prüfungen können manchmal auch gültige Bilder zurückweisen. Es wird dringend empfohlen, diese Funktion nur im Zusammenhang mit der Neucodierung von Dateien zu verwenden. Dabei versucht Wedge das beschädigte Bild neu zu erstellen. Sollte der Versuch fehlschlagen, wird das Bild zurückgewiesen.';
$helptxt['avatar_reencode'] = 'Diese Funktion versucht hochgeladene Benutzerbilder neu zu codieren. Das Neucodieren von Bilddateien ist eine sehr effinziente Sicherheitsmaßnahme. Beachte: alle animierten Bilder, die neu codiert wurden sind dann statisch!';

$helptxt['localCookies'] = 'Wedge verwendet Cookies um die Anmeldeinformationen auf dem Client-PC zu speichern.
...
$helptxt['default_timezone'] = 'Die Server Zeitzone teilt PHP mit, in welcher Zeitzone der Server steht. Weiterführende Informationen findest du auf: <a href="http://www.php.net/manual/en/timezones.php" target="_blank">PHP.net</a>.';
$helptxt['spamWaitTime'] = 'Ein Zeitintervall, den ein Benutzer zwischen zwei Beiträgen einhalten muss. Dies kann Spammern das Leben etwas schwerer machen.';

$helptxt['enablePostHTML'] = 'Erlaubt die Verwendung von gängigen HTML Befehlen:
...
$helptxt['themes'] = 'Hier kann das Standard- bzw. Gästelayout ausgewählt werden, Verzeichnisse der Themes ändern, Themes editieren, sowie individuelle Theme-Optionen eingestellt werden.';
$helptxt['theme_install'] = 'Hier können neue Themes installiert werden, indem ein schon vorhandenes Verzeichnis benutzt, ein Zip-Paket hochladen, oder das vorhandene Theme kopiert wird.<br /><br />Beachte: das Verzeichnis bzw. das Zip-Paket muss die Datei <tt>theme_info.xml</tt> enthalten.';
...
$helptxt['securityDisable_why'] = 'Das ist dein aktuelles Passwort (identisch mit dem, welches auch für die Anmeldung (Login) verwendet wird).<br /><br />Warum du das Paswort erneut eingeben solltest? Damit du dir darüber im klaren bist, dass <b>DU</b> Änderungen im Administrator-Center machen kannst und dafür alleine verantwortlich bist.';
$helptxt['emailmembers'] = 'In dieser Nachricht können folgende Variablen verwendet werden:<br />
...
$helptxt['failed_login_threshold'] = 'Anzahl der erfolglosen Login-Versuche, bevor der Benutzer zur "Passwort vergessen?" Seite weitergeleitet wird.';
$helptxt['enable_quick_login'] = 'Aktiviert eine kompakte Anmeldebox in der Sidebar für Gäste.';
$helptxt['oldTopicDays'] = 'Ist diese Option aktiviert, wird dem Benutzer eine Warnung ausgegeben, wenn er in einem Thema schreiben möchte, in welchem seit einer bestimmten Zeit (in Tagen) keiner mehr geantwortet hat. Den Wert auf 0 setzen, um die Funktion zu deaktivieren.';
$helptxt['edit_wait_time'] = 'Anzahl in Sekunden, bevor das Datum der letzten Bearbeitung von Beiträgen gespeichert wird.';
$helptxt['edit_disable_time'] = 'Anzahl in Minuten, nach denen ein Benutzer seine eigenen Beiträge noch bearbeiten kann. Den Wert auf 0 setzen, um die Funktion zu deaktivieren.<br /><br /><i>Beachte: diese Option hat keinen Einfluss auf die Benutzer, welche Beiträge anderer Mitglieder bearbeiten dürfen!</i>';
$helptxt['posts_require_captcha'] = 'Diese Option zwingt den Benutzer, einen Code von einem Bild einzugeben, bevor der Beitrag veröffentlicht wird. Dies betrifft nur die Benutzer, welche unter die angegebene Mindestanzahl von Beiträgen fallen und soll das Spammen durch automatische Skripte verhindern.';
$helptxt['disable_wysiwyg'] = 'Diese Option unterbindet die Verwendung des WYSIWYG-Editors ("What You See Is What You Get" - Was du siehst ist was du bekommen wirst) auf der Antwortseite.';
$helptxt['lastActive'] = 'Gibt die Minuten an, in denen die Besucher auf dem Foren-Index als aktiv gekennzeichnet werden. Die Standardzeit beträgt 15 Minuten.';
...
$helptxt['autoFixDatabase'] = 'Diese Funktion repariert automatisch auftretende Fehler in der Datenbank, wobei die Benutzer nichts davon merken werden. Das kann sinnvoll sein, andererseits ist das Forum bei Fehlern so lange funktionsuntüchtig, bis du von selbst darauf aufmerksam wirst. In diesem Fall wird eine E-Mail an dich geschickt.';

$helptxt['enableParticipation'] = 'Zeigt ein verändertes Symbol vor den Themen, in denen man selbst geantwortet hat.';
$helptxt['correctExclamations'] = 'Wenn diese Funktion aktiviert ist, hindert sie Benutzer daran, zu viele Ausrufe- oder Fragezeichen im Betreff-Feld zu verwenden und minimiert diese auf 1. Zum Beispiel: ein Thema mit dem Titel "Hilfe!!!!!!" wird zu "Hilfe!"';
$helptxt['correctShouting'] = 'Wenn der Wert auf über 0 gesetzt wird, werden Titel von Themen auf korrekte Schreibweise überprüft. Sollten mindestens 10 Buchstaben oder die angegebene Prozenthürde Großbuchstaben enthalten, werden diese Umgeschrieben. Zum Beispiel: "BITTE UM SCHNELLE HILFE" wird zu "Bitte Um Schnelle Hilfe" korrigiert. Die EInstellung von 0% deaktiviert diese Funktion.';

$helptxt['db_persist'] = 'Erhöht die Geschwindigkeit zur Datenbank, indem eine persistente Verbindung aufrecht erhalten wird. Wenn du einen dedizierten Server verwenden solltest, könnte dies eine tolle Option sein. Solltest du auf einem Shared Host vertrauen, könnte diese Funktion für Ärger sorgen.';
$helptxt['ssi_db_user'] = 'Optionale Einstellung. Erlaubt das Benutzen eines anderen Benutzernamens bzw. Passwortes für die Datenbank, wenn mit der Datei SSI.php gearbeitet wird.';

$helptxt['countChildPosts'] = 'Aktiviere diese Option, um die Beiträge und Themen der untergeordneten Foren zum Gesamtwert der Beiträge und Themen auf dem Board-Index zu addieren.<br /><br />Diese Funktion macht die Anzeige merklich langsamer, zeigt aber keine Boards mehr mit "0" an, wenn diese untergeordnete Boards mit Beiträgen enthalten..';
$helptxt['ignorable_boards'] = 'Diese Option erlaubt den Benutzern bestimmte Foren zu ignorieren. Ignorierte Foren erscheinen nicht in den neuen Beiträgen und den ungelesenen Themen.';
$helptxt['allow_ignore_topics'] = 'Diese Option erlaubt den Benutzern bestimmte Themen zu ignorieren, die nicht mehr in den <em>Ungelesenen Antworten</em> und <em>Ungelesenen Beiträgen</em> erscheinen.';

$helptxt['display_flags'] = 'Als Zusatz zur Standardsprache des Forums, können auch die verschiedenen Foren einer Sprache mit Anzeige einer Flagge zugeordnet werden:
	<ul class="normallist">
...
$helptxt['recycle_enable'] = '"Recycled"  gelöschte Themen und Beiträge in einem bestimmten Foren.';

$helptxt['max_pm_recipients'] = 'Diese Option erlaubt die Vergabe einer maximalen Anzahl von Empfängern, die ein Benutzer beim schreiben einer Privaten Mitteilung eingeben kann. Dies soll helfen, dass sogenannte Spammen im Forum zu vermeiden. Benutzer mit der Berechtigung zum Senden von Newslettern sind von dieser Beschränkung ausgenommen. 0 für kein Limit eingeben.';
$helptxt['pm_posts_verification'] = 'Diese Option zwingt den Benutzer, einen Code von einem Bild einzugeben, bevor die Private Mitteilung versendet werden kann. Dies betrifft nur die Benutzer, welche unter die angegebene mindestanzahl von Beiträgen fallen und soll das Spammen durch automatische Skripte verhindern.';
...
$helptxt['registration_method'] = 'Diese Option stellt verschiedene Möglichkeiten der Registrierung zur Verfügung. Die Auswahl sieht wie folgt aus:<br /><br />
	<ul class="normallist">
		<li>
...
$helptxt['send_validation_onChange'] = 'Alle Mitglieder müssen bei einer Änderung der Emailadresse diese bestätigen, bevor sie ihr Benutzerkonto wieder nutzen können.';
$helptxt['send_welcomeEmail'] = 'Diese Option versendet allen neuen Mitgliedern eine Willkommens Email, wenn diese sich im Forum registrieren.';
...
$helptxt['allow_hideOnline'] = 'Mit Aktivierung dieser Option, können alle Mitglieder ihren Online-Status verstecken (außer vor Administratoren). Wenn diese Option deaktiviert wird, können nur Mitglieder den Status verstecken, welche die Berechtigung haben, das Forum zu administrieren. Das Deaktivieren ändert keinen Status eines Mitglieds, es verhindert nur das Verstecken des Status in der Zukunft';

$helptxt['latest_themes'] = 'Dieser Bereich zeigt die neuesten und beliebtesten Layouts (Themes) von <a href="http://www.wedge.org/" target="_blank">www.wedge.org</a> an. Sollte dieser Bereich nicht sichtbar sein, kann dein Server <a href="http://www.wedge.org/" target="_blank">www.wedge.org</a> wahrscheinlich nicht kontaktieren.';

$helptxt['error_plugin_repo'] = 'Der letzte Aufruf des Repositorys, um zu prüfen ob in der Zwischenzeit Updates zu den Plugins vorhanden sind ist fehlgeschlagen. Bitte überprüfe, ob dieses Verzeichnis besteht und /oder ob du evtl. Benutzername und Passwort angeben musst.';
$helptxt['plugins_repo_active'] = 'Sollte ein Repository nicht als aktiv gekennzeichnet sein, kannst du trotzdem noch die "Anzeigen" Funktion verwenden. Allerdings werden Updates nicht automatische angezeigt. Also muss für jedes Plugin der Status manuell überprüft werden.';
$helptxt['plugins_password_blank'] = 'Es wurde kürzlich ein Passwort für dieses Repository angegeben, aber das Passwort liegt verschlüsselt auf dem Server, so dass es mit keiner anderen Person geteilt werden kann.<br><br>Wenn du möchtest, kannst du die Zugangsdaten wie Benutzername und Passwort hier ändern. Oder nichts eintragen, um den jetzigen Zustand beizubehalten.';

$helptxt['secret_why_blank'] = 'Zu deiner Sicherheit wird die Antwort (genauso wie dein Passwort) zu deiner Frage verschlüsselt, so dass Wedge dir nur mitteilen kann, ob es richtig oder falsch ist. Die Antwort oder das Passwort selbst nennen kann Wedge dagegen nicht!';
...
$helptxt['permissions'] = 'Berechtigungen haben die Funktion, bestimmten Gruppen Aktionen zu erlauben oder zu verbieten<br /><br />Du kannst mithilfe der Checkboxen mehrere Foren gleichzeitig, oder die Berechtigungen einer bestimmten Gruppe ändern, indem du auf "Ändern" klickst.';
$helptxt['permissions_board'] = 'Wenn ein Forum auf "Global" gesetzt ist, hat es keine speziellen Berechtigungen. "Lokal" dagegen hat eigene Berechtigungen, welche sich von anderen Foren unterscheiden und somit unterschiedliche Berechtigungen zwischen den unterschiedlichen Foren erlauben.';
$helptxt['permissions_quickgroups'] = 'Erlaubt das Verwenden von "vordefinierten" Berechtigungen - Standard bedeutet: "nichts spezielles", Beschränkt bedeutet: "wie ein Gast", Moderator vergibt Rechte "wie bei einem Moderator" und "Wartungsmodus" bedeutet, dass die Berechtigungen einem Administrator sehr nahe kommen.';
...
$helptxt['permissions_postgroups'] = 'Das Aktivieren der Berechtigungen für beitragsbasierte Gruppen erlaubt das Zuweisen von Berechtigungen an Mitglieder mit einer bestimmten Beitragszahl. Diese Berechtigungen werden zu den bereits vorhanden <em>addiert</em>.';
$helptxt['membergroup_guests'] = 'Die Mitgliedergruppe "Gäste" enthält alle Benutzer, die nicht angemeldet sind.';
$helptxt['membergroup_regular_members'] = 'Die Mitgliedergruppe "Normale Mitglieder" bezeichnet alle Benutzer die angemeldet sind, jedoch keiner primären Mitgliedergruppe angehören.';
$helptxt['membergroup_administrator'] = 'Der Administrator kann alles im Forum machen und jedes Forum ansehen. Es gibt keine Berechtigungseinstellungen für den Administrator';
$helptxt['membergroup_moderator'] = 'Die Mitgliedergruppe "Moderator" ist eine spezielle Gruppe. Die zugewiesenen Berechtigungen und Einstellungen gelten <em>nur in den Foren, in denen die betroffenen Mitglieder als Moderator eingetragen sind</em>. Außerhalb dieser Foren werden sie wie normale Benutzer behandelt.';
$helptxt['membergroups'] = 'In Wedge gibt es zwei Arten von Gruppen, denen die Mitglieder zugeteilt sind:
	<ul>
...
$helptxt['maintenance_members'] = 'Diese Funktion erlaubt das <b>komplette</b> und <b>unwiderrufliche</b> Löschen von Benutzerkonten aus dem Forum. Es wird <b>dringend empfohlen</b>, davor eine Sicherung der Daten durchzuführen, für den Fall, dass etwas gelöscht wird, was Sie nicht gewollt war.<br /><br />Verwende diese Funktion mit entsprechender Vorsicht!';
...
$helptxt['avatar_external'] = 'Erlaubt den betreffenden Mitgliedern, ihre Benutzerbilder von anderen Servern zu verlinken. Der Nachteil ist, dass Bilder verlinkt werden können, die nicht im Forum erwünscht sind (pornografische/gewalttätige Inhalte).';
$helptxt['avatar_download_external'] = 'Aktiviere diese Option, um das externe Benutzerbild auf deinen Server herunterzuladen. Sollte das herunterladen erfolgreich sein, wird es danach wie ein hochgeladenes Benutzerbild behandelt.';
$helptxt['avatar_upload'] = 'Diese Option gleicht dem externen Benutzerbild, hat aber den Vorteil, dass mehr Kontrolle über die Benutzerbilder möglich sind und die Mitglieder keine Möglichkeit benötigen, ihre Benutzerbilder selbst hochzuladen.<br /><br />Der Nachteil ist, dass entsprechend mehr Platz auf dem Server bereitgestellt werden muss.';
$helptxt['avatar_download_png'] = 'PNGs sind größer, bieten aber eine bessere Kompression (und damit Qualität). Sollte dies nicht aktiviert sein, werden stattdessen JPEG Bilder verwendet - welche meistens kleiner in der Größe sind, jedoch eine schlechtere Qualität bieten.';
$helptxt['gravatar_settings'] = 'Gravatare sind eine Form von Globalen Benutzerbildern. Diese werden verwaltet von <a href="http://www.gravatar.com/">Gravatar.com</a>. Dort kannst du deinen Gravatar hinzufügen und an vielen Stellen im Netz automatisch verwenden. Bestes Beispiel: Wordpress.';
$helptxt['gravatarEnabled'] = 'Wenn diese Option aktiviert ist, sind Gravatare für die Benutzer verfügbar. Falls deaktiviert, sind sie für keinen Benutzer verfügbar.';
$helptxt['gravatarOverride'] = 'Wenn diese Option ausgewählt ist, haben Mitglieder keine Möglichkeit, ein eigenes Benutzerbild auf diesen Server zu laden, können aber automatisch ihren Gravatar an dieser Stelle verwenden.';
$helptxt['gravatarAllowExtraEmail'] = 'Wenn diese Option ausgewählt ist, haben Mitglieder die Berechtigung eine alternative Emailadresse anzugeben, zusätzlich zu ihrer normalen Adresse. Viele User verwenden unterschiedliche Emailadressen für unterschiedliche Gravatare.';
$helptxt['gravatarMaxRating'] = 'Wenn ein Gravatar erstellt wird, können die Benutzer eine Bewertung dafür integrieren. Ähnlich wie der <a href="http://en.wikipedia.org/wiki/Motion_Picture_Association_of_America_film_rating_system" target="_blank">MPAA-style</a>. Zum Beispiel: wenn ein Gravatar mit G bewertet ist, ist er ganz OK. Enthält er obszönes Material, wird er mit  R oder X bewertet. Es kann festgelegt werden, welche Gravatare hier in diesem Forum verwendet werden dürfen.';
$helptxt['avatar_defaults'] = 'Diese Einstellungen erlauben ein paar Finetuning-Einstellungen für dein Forum. Zum Beispiel die Zuordnung eines Benutzerbildes für Mitglieder ohne eigenes Bild.';
$helptxt['avatar_banned_hide'] = 'Diese Funktion versteckt die Benutzerbilder von gesperrten Mitgliedern., als ob sie kein Benutzerbild besitzen würden.<br><br>Das Benutzerbild wird nicht gelöscht für den Fall, dass die Sperre gegen den User aufgehoben wird.';

$helptxt['disableHostnameLookup'] = 'Deaktiviert die Suche nach den Hostnamen, was manche Server sehr langsam macht. Beachte, dass dies Auswirkungen auf das sperren von Mitgliedern hat.';

$helptxt['search_weight_frequency'] = 'Gewichtungsfaktoren werden benutzt, um die Relevanz eines Suchresultates zu bestimmen. Veränderungen an diesen Gewichtungen werden vorgenommen, um die Resultate auf das Forum abzustimmen. Das Forum einer News-Seite zum Beispiel benötigt eine hohe Gewichtung auf \'Alter der neuesten Übereinstimmung\'. Alle Werte sind relativ zueinander und sollten positive Zahlen sein.<br /><br />Dieser Faktor zählt die Anzahl der übereinstimmenden Beiträge und teilt sie durch die gesamte Zahl der Beiträge innerhalb eines Themas.';
$helptxt['search_weight_age'] = 'Gewichtungsfaktoren werden benutzt, um die Relevanz eines Suchresultates zu bestimmen. Veränderungen an diesen Gewichtungen werden vorgenommen, um die Resultate auf das Forum abzustimmen. Das Forum einer News-Seite zum Beispiel benötigt eine hohe Gewichtung auf \'Alter der neuesten Übereinstimmung\'. Alle Werte sind relativ zueinander und sollten positive Zahlen sein.<br /><br />Dieser Faktor bewertet das Alter der neuesten Übereinstimmung innerhalb eines Themas. Je neuer der Beitrag, desto höher ist die Bewertung.';
$helptxt['search_weight_length'] = 'Gewichtungsfaktoren werden benutzt, um die Relevanz eines Suchresultates zu bestimmen. Veränderungen an diesen Gewichtungen werden vorgenommen, um die Resultate auf Ihr Forum abzustimmen. Das Forum einer News-Seite zum Beispiel benötigt eine hohe Gewichtung auf \'Alter der neuesten Übereinstimmung\'. Alle Werte sind relativ zueinander und sollten positive Zahlen sein.<br /><br />Dieser Faktor basiert auf der Themengröße. Je mehr Beiträge innerhalb eines Themas, desto höher ist die Bewertung.';
$helptxt['search_weight_subject'] = 'Gewichtungsfaktoren werden benutzt, um die Relevanz eines Suchresultates zu bestimmen. Veränderungen an diesen Gewichtungen werden vorgenommen, um die Resultate auf Ihr Forum abzustimmen. Das Forum einer News-Seite zum Beispiel benötigt eine hohe Gewichtung auf \'Alter der neuesten Übereinstimmung\'. Alle Werte sind relativ zueinander und sollten positive Zahlen sein.<br /><br />Dieser Faktor schaut nach dem Vorhandensein einer Suchanfrage innerhalb des Betreffs eines Themas.';
$helptxt['search_weight_first_message'] = 'Gewichtungsfaktoren werden benutzt, um die Relevanz eines Suchresultates zu bestimmen. Veränderungen an diesen Gewichtungen werden vorgenommen, um die Resultate auf Ihr Forum abzustimmen. Das Forum einer News-Seite zum Beispiel benötigt eine hohe Gewichtung auf \'Alter der neuesten Übereinstimmung\'. Alle Werte sind relativ zueinander und sollten positive Zahlen sein.<br /><br />Dieser Faktor schaut nach der Übereinstimmung des Suchbegriffs im ersten Beitrag eines Themas.';
...
$helptxt['see_member_ip'] = 'Deine IP-Adresse wird nur dir und den Moderatoren dieser Seite angezeigt. Beachte, dass diese Daten nicht die Person identifizieren, da IP-Adressen häufig nach einer gewissen Zeit wechseln.<br /><br />Du kannst keine IP-Adressen anderer Benutzer sehen und diese können deine nicht sehen.';
$helptxt['whytwoip'] = 'Wedge verwendet mehrere Methoden, um die IP-Adressen zu bestimmen. Normalerweise finden beide Methoden ein und dieselbe Adresse. In manchen Fällen werden jedoch zwei Adressen gefunden, welche von Wedge protokolliert werden und zum Kontrollieren eines Banns etc. verwendet werden. Du kannst auf eine der beiden Adressen klicken, um diese zu verfolgen und ggf. zu sperren.';
...
$helptxt['pm_bcc'] = 'Wenn du eine Private Mitteilung versenden möchtest, kannst du einen weiteren Empfänger als BCC bzw. "Blindkopie" hinzufügen. Die Identität der BCC Empfänger wird den anderen Empfängern nicht mitgeteilt, er erhält die Mitteilungen anonym und ohne Wissen der anderen.';
...
$helptxt['chmod_flags'] = 'Du kannst die Dateiberechtigungen auf einen selbst bestimmten Wert setzen. Gebe dazu einen numerischen CHMOD-Wert an. Beachte: diese Einstellung hat keine Auswirkungen auf Mircosoft Windows Betriebssysteme.';
...
$helptxt['field_show_enclosed'] = 'Umschließt die Benutzereingaben mit Text oder HTML. Dies erlaubt es weitere Sofortnachrichtenquellen, Bilder, Einbettungen oder Ähnliches hinzuzufügen. Beispielsweise:<br/><br/>
...
$helptxt['custom_mask'] = 'Die Eingabemaske ist für die Forensicherheit wichtig. Das Validieren der Benutzereingaben stellt sicher, dass Daten nicht in einer Weise genutzt werden, die nicht erwartet werden. Wir haben einige einfache reguläre Ausdrücke als Hinweise gegeben.<br /><br />
...
$helptxt['reverse_proxy'] = 'Falls du Bad Behavior hinter einem Reverse Proxy, Load Balancer, HTTP Beschleuniger, Content Cache oder ähnliches verwendest, aktiviere diese Funtion.';
$helptxt['reverse_proxy_header'] = 'Dein Reverse Proxy Server muss die IP-Adresse vom Clienten im Header weitergeben. Typischerweise wird dafür: <a href="http://de.wikipedia.org/wiki/X-Forwarded-For">X-Forwarded-For</a> verwendet. Du musst sicherstellen, dass in deinem Proxy Server diese Funktion aktiviert ist. Einige andere Namen im Header können sein: "X-Real-Ip" (nginx) und "Cf-Connecting-Ip" (CloudFlare).';
$helptxt['reverse_proxy_ips'] = 'In diesem Bereich müssen die IP-Adressen (z.B. 127.0.0.1) oder Adressblöcke (z.B. 127.0.0.0/8) der Proxy Server angegeben werden. Solltest du einen vorgelagerten Proxy Server zusätzlich zu einem anderen verwenden, müssen <em>alle</em> verwendeten IP Adressen ud Adressbereiche angegeben werden. Andernfalls ist es unmöglich, die richtige IP-Adresse des Klienten herauszufiltern.';

$helptxt['signature_minposts'] = 'Einerseits können Berechtigungen verwendet werden um Signaturen zu kontrollieren, andererseits bietet sich auch die Möglichkeit, die Signatur vor anderen Mitgliedern zu verstecken. Diese Funktion ist ein wirksamer Schutz gegen Spammer.';

$helptxt['media_permissions'] = 'Hier kannst du die verschiedenen Berechtigungsprofile hinzufügen, bearbeiten, oder löschen. Das Profil kann einem einzelnen Album oder mehreren Alben zugeteilt werden. Alle neu erstellten oder zugeteilten Alben folgen den festgelegten Berechtigungen.';

// Help popup for the Media tag...
$helptxt['mediatag'] = '<h2>Was hat es mit dem [media] tag auf sich?</h2>
