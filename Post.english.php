...
$txt['shortcuts'] = 'shortcuts: hit <kbd>alt+s</kbd> to submit/post or <kbd>alt+p</kbd> to preview';
$txt['shortcuts_firefox'] = 'shortcuts: hit <kbd>shift+alt+s</kbd> to submit/post or <kbd>shift+alt+p</kbd> to preview';
$txt['option'] = 'Option';
