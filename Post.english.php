...
$txt['shortcuts'] = 'shortcuts: hit <kbd>shift+enter</kbd> to use smart tag closer, <kbd>alt+s</kbd> to submit or <kbd>alt+p</kbd> to preview';
$txt['shortcuts_opera'] = 'shortcuts: hit <kbd>shift+enter</kbd> to use smart tag closer, <kbd>shift+esc</kbd> then <kbd>s</kbd> to submit or <kbd>p</kbd> to preview';
$txt['shortcuts_firefox'] = 'shortcuts: hit <kbd>shift+enter</kbd> to use smart tag closer, <kbd>shift+alt+s</kbd> to submit or <kbd>shift+alt+p</kbd> to preview';
$txt['option'] = 'Option';
