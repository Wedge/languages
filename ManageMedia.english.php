...
$txt['media_admin_settings_use_zoom_subtext'] = 'Zoomedia is a JavaScript-powered lightbox module that adds animated transitions when clicking on previews (zoom and fade-in/out). Disable to prevent the use of Zoomedia on all albums. If enabled, album owners may still disable Zoomedia per-album in the album settings.';
