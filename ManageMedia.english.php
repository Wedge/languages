...
$txt['media_lookups'] = 'Enable Lookups';
$txt['media_lookup_success'] = 'This feature WILL work on your server';
$txt['media_lookup_fail'] = 'This feature will NOT work on your server';
$txt['media_max_per_post'] = 'Max Embedding Per Post';
$txt['media_max_per_page'] = 'Max Embedding Per Page';
$txt['media_max_warning'] = 'Too much Flash is bad for your browser\'s health';
$txt['media_quotes'] = 'Enable Embedding in Quotes';
$txt['media_mov'] = 'MOV Files (via Quicktime)';
$txt['media_real'] = 'RAM/RM Files (via Real Media)';
$txt['media_wmp'] = 'WMV/WMA Files (via Windows Media)';
$txt['media_swf'] = 'SWF Flash animations';
$txt['media_flv'] = 'FLV Flash videos';
$txt['media_divx'] = 'DivX files (.divx)';
$txt['media_avi'] = 'AVI files (via DivX player)';
$txt['media_mp3'] = 'MP3 files (via Flash player)';
$txt['media_mp4'] = 'MP4 files (via Flash player)';
$txt['media_ext'] = 'Allowed file extensions';
$txt['media_fix_html'] = 'Fix uses of the embed HTML with an embeddable link';
$txt['media_includeurl'] = 'Include the Original Link';
$txt['media_includeurl_desc'] = '(for sites that don\'t have it in the player)';
$txt['media_debug'] = 'Auto-Embed Debug Mode (Admin Only)';
$txt['media_debug_desc'] = 'Time taken to auto embed is appended to each post.';
$txt['media_local'] = 'Embed Local Files [Excludes attachments]';
$txt['media_local_desc'] = 'Local means on the same server. But this doesn\'t allow ANY file of this type to be embedded from anywhere.';
$txt['media_denotes'] = '(Sites marked with * require lookups)';
$txt['media_fish'] = '(Sites marked with * require lookups, however lookups will NOT work on your server.<br /> Therefore unless you manually fish for an embeddable url yourself, embedding will NOT work for these sites.)';
$txt['media_pop_sites'] = 'Popular Sites';
$txt['media_video_sites'] = 'Video Sites';
$txt['media_audio_sites'] = 'Audio Sites';
$txt['media_other_sites'] = 'Other Sites';
$txt['media_adult_sites'] = 'Adult Sites';
$txt['media_custom_sites'] = 'Custom Sites';
$txt['media_disable'] = 'Disable Embedding';
$txt['media_new_version'] = 'A new version (<a href="%s">%s</a>) is available!';
$txt['media_current_version'] = 'Current version: %s';
$txt['media_sitelist_updated'] = 'The site list has been updated to the latest version!';
$txt['media_titles'] = 'Store &amp; show video titles';
$txt['media_titles_desc'] = '(if site is supported by Wedge)';
$txt['media_titles_yes'] = 'Yes, lookup and show';
$txt['media_titles_yes2'] = 'Yes, but don\'t store anything new';
$txt['media_titles_no'] = 'No, but keep looking them up for later';
$txt['media_titles_no2'] = 'No, don\'t store and don\'t show';
$txt['media_inlinetitles'] = 'Show title inside video thumbnails';
$txt['media_inlinetitles_desc'] = '(for supported sites, such as YouTube and Vimeo)';
$txt['media_inlinetitles_yes'] = 'Yes';
$txt['media_inlinetitles_maybe'] = 'Only if the title isn\'t already stored';
$txt['media_inlinetitles_no'] = 'No';
$txt['media_noscript'] = 'Use earlier, Javascript-less, embedding system';
$txt['media_noscript_desc'] = 'Only use if you have compatibility issues';
$txt['media_expins'] = 'Show Flash express installer';
$txt['media_expins_desc'] = 'If the user\'s Flash version is outdated, movies will offer to upgrade it';
$txt['media_lookups_desc'] = 'Most of the auto-embedder\'s features require a lookup';
$txt['media_center'] = 'Center videos horizontally';
$txt['media_center_desc'] = 'Or add "-center" to any video\'s anchor settings (e.g. #ws-center)';
$txt['media_sitelist_added'] = 'The following site(s) were added:';
$txt['media_sitelist_removed'] = 'The following site(s) were removed:';
$txt['media_sitelist_modified'] = 'The following site(s) were modified:';
$txt['media_lookup_titles'] = 'Try to find titles in all sites';
$txt['media_lookup_titles_desc'] = '(even when they\'re not supported - you never know)';
$txt['media_incontext'] = 'Enable Embedding in Sentences';
$txt['media_checkadmin'] = 'Restrict manual updates to admins';
$txt['media_checkadmin_desc'] = 'If enabled, only you will be able to update the sitelist (see readme.txt)';
$txt['media_nonlocal'] = 'Accept external websites in addition to local embeds';
$txt['media_nonlocal_desc'] = 'In case it isn\'t clear: this isn\'t a recommended setting, at least security-wise.';
$txt['media_max_width'] = 'Maximum width for embedded videos';
$txt['media_max_width_desc'] = 'Leave empty to disable. Enter 600 for a maximum width of 600 pixels. Larger videos will be resized, while smaller videos will add a link to let you resize them to the maximum width.';
$txt['media_yq'] = 'Default YouTube quality';
$txt['media_yq_default'] = 'Default';
$txt['media_yq_hd'] = 'HD where available';
$txt['media_small'] = 'Small';
...
$txt['media_admin_settings_title_tag'] = 'Embed code and [smg] tags';
$txt['media_admin_settings_title_misc'] = 'Miscellaneous';
$txt['media_admin_settings_welcome'] = 'Welcome message';
$txt['media_admin_settings_welcome_subtext'] = 'Leave empty to use $txt[\'media_welcome\'] in the Modifications.english.php file (which you can set in multiple languages), or the default welcome message.';
$txt['media_admin_settings_data_dir_path'] = 'Data directory path';
$txt['media_admin_settings_data_dir_path_subtext'] = 'Server path (e.g. /home/www/media)';
...
$txt['media_admin_settings_use_exif_date'] = 'Use Exif datetime for upload date if available';
$txt['media_admin_settings_use_exif_date_subtext'] = 'If the file has Exif data available, the upload date will use its datetime setting instead of the current time.';
...
$txt['media_admin_settings_max_file_size_subtext'] = 'Set to 0 and use the Quotas section to finetune.';
...
$txt['media_admin_settings_allow_over_max_subtext'] = 'If uploaded pictures are over the max width or height, the server will attempt to resize them to match the max size specifications. Not recommended on overloaded servers. Select &quot;No&quot; to reject such pictures.';
$txt['media_admin_settings_upload_security_check'] = 'Enable security check at upload time';
$txt['media_admin_settings_upload_security_check_subtext'] = 'Prevents users from uploading malicious files, but may also rarely reject some healthy files. It isn\'t recommended to enable this, unless you have some really, really stupid IE users looking for trouble.';
$txt['media_admin_settings_log_access_errors'] = 'Log access errors';
$txt['media_admin_settings_log_access_errors_subtext'] = 'If enabled, all <em>Access denied</em> errors within the Media area will show up in your general error log.';
$txt['media_admin_settings_ftp_file'] = 'File path to the Safe Mode file';
$txt['media_admin_settings_ftp_file_subtext'] = 'Read the MGallerySafeMode.php for more details. Required if your server has Safe Mode enabled!';
$txt['media_admin_settings_jpeg_compression'] = 'Jpeg Compression';
$txt['media_admin_settings_jpeg_compression_subtext'] = 'Determines the quality of resized pictures, including previews and thumbnails. Choose between 0 (bad quality, small file) and 100 (high quality, large file). The default value (80) is recommended. Values between 65 and 85 are the best compromise.';
$txt['media_admin_settings_show_extra_info'] = 'Show Exif data';
$txt['media_admin_settings_show_info'] = 'Exif metadata to show';
$txt['media_admin_settings_show_info_subtext'] = 'Pictures taken by digital devices often embed useful information, such as the day the picture was taken. Here you can choose what information you want to show or not.';
$txt['media_admin_settings_num_items_per_page'] = 'Max items per page';
$txt['media_admin_settings_max_thumbs_per_page'] = 'Max [smg] tags per page';
$txt['media_admin_settings_max_thumbs_per_page_subtext'] = 'Maximum number of [smg] tags that will get processed on a page (they will get converted to thumbnails).';
...
$txt['media_admin_settings_max_preview_width_subtext'] = 'The preview is a clickable picture that is displayed on the full-size picture\'s page, to speed up loading. Set to 0 to disable. <b>Warning</b>: if disabled, large pictures might break your template layout.';
$txt['media_admin_settings_max_preview_height'] = 'Max preview height';
$txt['media_admin_settings_max_preview_height_subtext'] = 'Same. If width or height is set to 0, preview images are disabled.';
$txt['media_admin_settings_max_bigicon_width'] = 'Max icon width';
$txt['media_admin_settings_max_bigicon_width_subtext'] = 'Album icons have a thumbnail (which uses the size set in the Max thumbnail size section), and a regular size, which is used only on album pages. This sets the width for a regular size album icon.';
$txt['media_admin_settings_max_bigicon_height'] = 'Max icon height';
$txt['media_admin_settings_max_bigicon_height_subtext'] = 'Same. This sets the height for a regular size album icon.';
$txt['media_admin_settings_max_title_length'] = 'Maximum title length';
$txt['media_admin_settings_max_title_length_subtext'] = 'Maximum number of characters to show for titles above thumbnails. If cut, they can still be read when hovering over the thumbnail.';
...
$txt['media_admin_settings_use_lightbox'] = 'Use Lightbox (animated transitions)';
$txt['media_admin_settings_use_lightbox_subtext'] = 'A Lightbox is a Javascript module that adds drop shadows to pictures and animated transitions when clicking on previews (zoom and fade-in/out). Disable to prevent the use of the Lightbox on all albums. If enabled, album owners may still disable the lightbox per-album in the album settings.';
...
$txt['media_admin_settings_entities_convert'] = 'Convert UTF-8 strings to entities?';
$txt['media_admin_settings_entities_convert_subtext'] = 'Strings might take a bit more space in the database, but this will allow text to always be readable.';
...
$txt['media_admin_settings_default_tag_type'] = 'Default size within [smg] tags?';
$txt['media_admin_settings_default_tag_type_subtext'] = 'Choose the image type that should be shown by default when no type is specified on [smg id=xxx type=xxx] tags.';
...
$txt['media_admin_settings_player_color_subtext'] = 'In hexadecimal code. By default, white (FFFFFF)';
$txt['media_admin_settings_player_bcolor'] = 'Audio/video player\'s background color';
$txt['media_admin_settings_player_bcolor_subtext'] = 'In hexadecimal code. By default, black (000000)';
$txt['media_admin_settings_audio_player_width'] = 'Audio player\'s width';
$txt['media_admin_settings_audio_player_width_subtext'] = 'In pixels. By default, 400';
$txt['media_admin_settings_phpini_subtext'] = 'This server-side variable limits upload sizes. You can set it via a php.ini file, see details on the right';
$txt['media_admin_settings_clear_thumbnames'] = 'Leave thumbnail URLs in clear view';
$txt['media_admin_settings_clear_thumbnames_subtext'] = 'If enabled, thumbnails will be linked by their direct URL. Saves much server processing time but slightly less secure.';
$txt['media_admin_settings_album_columns'] = 'Max sub-albums per line';
$txt['media_admin_settings_album_columns_subtext'] = 'Default is 1. If you have a lot of sub-albums, you may want to set this to 2 or 3 so that more albums are shown per row.';
$txt['media_admin_settings_icons_only'] = 'Use icon shortcuts in item boxes';
$txt['media_admin_settings_icons_only_subtext'] = 'If this is enabled, item boxes, such as the ones that show lists of items in album pages, will only show icons next to relevant information, rather than full text such as <i>Posted by</i>.';
$txt['media_admin_settings_disable_rss'] = 'Disable RSS icons';
$txt['media_admin_settings_disable_rss_subtext'] = 'Don\'t show RSS feed icons in the media area. You can still add your own RSS links anywhere you want, they will still work.';
$txt['media_admin_settings_disable_playlists'] = 'Disable User Playlists';
$txt['media_admin_settings_disable_playlists_subtext'] = 'This entirely disables the Playlists feature.';
$txt['media_admin_settings_disable_comments'] = 'Disable item comments';
$txt['media_admin_settings_disable_comments_subtext'] = 'Don\'t show existing comments on items, and disallow posting comments.';
$txt['media_admin_settings_disable_ratings'] = 'Disable ratings';
$txt['media_admin_settings_disable_ratings_subtext'] = 'Don\'t show existing ratings on items, and disallow item rating.';
...
$txt['media_admin_maintenance_checkfiles_subtext'] = 'Checks for unused files (not found in the aeva_media table); if any are found, the system will allow removal.';
$txt['media_admin_maintenance_checkorphans'] = 'Check for orphan files';
$txt['media_admin_maintenance_checkorphans_subtext'] = 'Checks for orphan files (not found in the aeva_files table); if any are found, the system will allow removal. <strong>Warning</strong>: launching this task will render your gallery <strong>unusable</strong> until its 3 phases are completed. It can take a long time on a large gallery.';
...
$txt['media_admin_maintenance_regen_all_subtext'] = 'This will delete and regenerate all thumbnails and previews that can be rebuilt from their original source.';
$txt['media_admin_maintenance_regen_embed_subtext'] = 'This will delete and regenerate all current thumbnails, but only for <b>embedded (remote)</b> items. (YouTube, etc.)';
$txt['media_admin_maintenance_regen_thumb_subtext'] = 'This will delete and regenerate all thumbnails that can be rebuilt from their original source.';
$txt['media_admin_maintenance_regen_preview_subtext'] = 'This will delete and regenerate all previews that can be rebuilt from their original source.';
...
$txt['media_admin_maintenance_recount_subtext'] = 'Recounts totals and statistics and updates them, can be used to fix incorrect stats.';
$txt['media_admin_maintenance_finderrors_subtext'] = 'Tries to find some common errors like missing file (either from DB or physically) or incorrect id of last comment or item.';
$txt['media_admin_maintenance_prune_subtext'] = 'Purge items/comments based on specific parameters.';
$txt['media_admin_maintenance_browse_subtext'] = 'Browse gallery files and show the disk usage of each directory/file.';
...
$txt['media_admin_ban_type_2'] = 'Adding items';
$txt['media_admin_ban_type_3'] = 'Adding comments';
$txt['media_admin_ban_type_4'] = 'Adding items and comments';
...
$txt['media_album_hidden_subtxt'] = 'Enable this to prevent anyone but you from browsing this album. Its items can STILL be viewed by authorized membergroups. You may want to use this if you want to use it as a container for blog or forum post illustrations.';
$txt['media_allowed_members'] = 'Allowed members (read access)';
$txt['media_allowed_members_subtxt'] = 'Enter a comma-separated list of members whom you want to be able to view the album, even if their membergroups won\'t allow them to.';
$txt['media_allowed_write'] = 'Allowed members (write access)';
$txt['media_allowed_write_subtxt'] = 'Enter a comma-separated list of members whom you want to be able to upload to the album, even if their membergroups won\'t allow them to.';
$txt['media_denied_members'] = 'Denied members (read access)';
$txt['media_denied_members_subtxt'] = 'Enter a comma-separated list of members whom you don\'t want to allow viewing this album, even if their membergroups are allowed to.';
$txt['media_denied_write'] = 'Denied members (write access)';
$txt['media_denied_write_subtxt'] = 'Enter a comma-separated list of members whom you don\'t want to allow posting to this album, even if their membergroups are allowed to.';
...
$txt['media_admin_bans_mems_empty'] = 'Members were not specified';
...
$txt['media_admin_smf_ver'] = 'SMF Version';
...
$txt['media_admin_thanks'] = 'Thanks to...';
...
$txt['media_admin_icon_edit_subtext'] = 'If you re-upload the icon, the old one will be overwritten. Leave empty to keep the current icon.';
$txt['media_admin_bans_mems_empty'] = 'Members were not specified';
...
$txt['media_cf_options_stext'] = 'Add options for the fields, only valid if the field types are checkbox, select or radio. Use comma (,) as a separator';
