...
$txt['media_admin_settings_icons_only_desc'] = 'If this is enabled, item boxes, such as the ones that show lists of items in album pages, will only show icons next to relevant information, rather than full text such as <i>Posted by</i>.';
...
$txt['media_allowed_members_desc'] = 'Enter a comma-separated list of members whom you want to be able to view the album, even if their membergroups won\'t allow them to.';
$txt['media_allowed_write'] = 'Allowed members (write access)';
$txt['media_allowed_write_desc'] = 'Enter a comma-separated list of members whom you want to be able to upload to the album, even if their membergroups won\'t allow them to.';
$txt['media_denied_members'] = 'Denied members (read access)';
$txt['media_denied_members_desc'] = 'Enter a comma-separated list of members whom you don\'t want to allow viewing this album, even if their membergroups are allowed to.';
$txt['media_denied_write'] = 'Denied members (write access)';
$txt['media_denied_write_desc'] = 'Enter a comma-separated list of members whom you don\'t want to allow posting to this album, even if their membergroups are allowed to.';
