...
$txt['embed_new_version'] = 'A new version (<a href="%s">%s</a>) is available!';
$txt['embed_current_version'] = 'Current version: %s';
$txt['embed_sitelist_updated'] = 'The site list has been updated to the latest version!';
...
$txt['embed_sitelist_added'] = 'The following site(s) were added:';
$txt['embed_sitelist_removed'] = 'The following site(s) were removed:';
$txt['embed_sitelist_modified'] = 'The following site(s) were modified:';
...
$txt['embed_checkadmin'] = 'Restrict manual updates to admins';
$txt['embed_checkadmin_desc'] = 'If enabled, only you will be able to update the sitelist (see readme.txt)';
...
$txt['media_admin_settings_disable_feed'] = 'Disable feed icons';
$txt['media_admin_settings_disable_feed_subtext'] = 'Don\'t show feed (e.g. RSS) icons in the media area. You can still add your own feed links anywhere you want, they will still work.';
...
$txt['media_admin_maintenance_checkfiles_subtext'] = 'Checks for unused files (not found in the media_items table); if any are found, the system will allow removal.';
$txt['media_admin_maintenance_checkorphans'] = 'Check for orphan files';
$txt['media_admin_maintenance_checkorphans_subtext'] = 'Checks for orphan files (not found in the media_files table); if any are found, the system will allow removal. <strong>Warning</strong>: launching this task will render your gallery <strong>unusable</strong> until its 3 phases are completed. It can take a long time on a large gallery.';
