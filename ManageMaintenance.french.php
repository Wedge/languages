...
$txt['repair_operation_missing_log_mark_read'] = 'Informations sur les messages lus liées à une section inexistante';
...
$txt['errortype_database_desc'] = 'Erreurs causées par des requêtes malformées. Notez-les et rapportez-les à l\'équipe de développement de Wedge.';
...
$txt['errortype_mail'] = 'E-mail';
$txt['errortype_mail_desc'] = 'Erreurs produites durant l\'envoi d\'un mail. La plupart de ces erreurs proviennent d\'un souci de configuration.';
$txt['errortype_filenotfound'] = 'Fichier introuvable';
...
$txt['maintain_optimize_info'] = 'Cette fonction vous permet d\'optimiser toutes les tables. Elle supprime les espaces inutilisés et réduit la taille de votre base de données, mais peut parfois impacter légèrement sa performance.';
...
$txt['maintain_old_are_not_pinned'] = 'Mais ne pas compter les sujets épinglés.';
...
$txt['reattribute_user'] = 'Ou fusionner à partir de cet utilisateur&#8239;:';
...
$txt['reattribute_confirm_merge'] = 'Êtes-vous sûr de vouloir fusionner les comptes des membres "%find%" et "%member_to%"&#8239;?';
$txt['reattribute_confirm_username'] = 'pour nom d\'utilisateur';
$txt['reattribute_confirm_email'] = 'pour adresse e-mail';
$txt['reattribute_cannot_find_member'] = 'Le membre à qui réattribuer les messages est introuvable.';
$txt['reattribute_cannot_find_member_from'] = 'Le membre à fusionner est introuvable.';
