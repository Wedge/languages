...
$txt['personal_text'] = 'Texte personnalisé';
...
$txt['gravatar_noAlternateEmail'] = 'Le Gravatar montré sera celui correspondant à l\'adresse e-mail de votre compte.';
$txt['avatar_resize_warning'] = 'Les avatars plus grands que %1$dx%2$d pixels seront peut-être redimensionnés. Notez que redimensionner un avatar animé le rendra statique.';
$txt['avatar_resize_forbid'] = 'Les avatars plus grands que %1$dx%2$d pixels ne sont pas autorisés.';
$txt['avatar_resize_warning_width'] = 'Les avatars plus larges que %1$d pixels seront peut-être redimensionnés. Notez que redimensionner un avatar animé le rendra statique.';
$txt['avatar_resize_forbid_width'] = 'Les avatars plus larges que %1$d pixels ne sont pas autorisés.';
$txt['avatar_resize_warning_height'] = 'Les avatars plus hauts que %1$d pixels seront peut-être redimensionnés. Notez que redimensionner un avatar animé le rendra statique.';
$txt['avatar_resize_forbid_height'] = 'Les avatars plus hauts que %1$d pixels ne sont pas autorisés.';
$txt['date_format'] = 'Cette sélection change le format d\'affichage des dates sur ce forum.';
$txt['choose_time_format'] = 'Format de l\'heure';
...
$txt['statPanel_topBoards_posts'] = '%1$d messages sur les %2$d de ce site (%3$01.2f%%)';
...
$txt['editBuddyIgnoreLists'] = 'Contacts et Ignorés';
$txt['editBuddies'] = 'Modifier la liste de Contacts';
...
$txt['notifications_general'] = 'Générales';
$txt['notifications_posts'] = 'Sujets et messages';
...
$txt['errors_from_ip'] = 'Messages d\'erreur depuis l\'IP ou plage IP %1$s';
$txt['errors_from_ip_desc'] = 'Ci-dessous est affichée une liste de toutes les erreurs générées par cette IP ou plage d\'IP.';
...
$txt['members_from_ip'] = 'Membres sur la IP ou plage d\'IP %1$s';
...
$txt['registration_not_activated'] = 'Desolé, ce compte n\'a pas encore été activé. Si vous n\'avez pas reçu l\'e-mail d\'activation, cliquez <a href="%1$s">ici</a> pour le renvoyer.';
...
$txt['whois_title'] = 'Chercher l\'IP %1$s sur un serveur WHOIS régional';
...
$txt['no_infraction_history'] = 'Cette personne n\'a jamais reçu de sanctions à ce jour.';
$txt['no_infraction_history_you'] = 'Vous n\'avez jamais reçu de sanctions à ce jour.';
...
$txt['issue_adhoc_infraction_desc'] = 'Vous pouvez appliquer l\'une des sanctions prédéfinies ci-après, ou en utiliser une comme base à personnaliser.';
...
$txt['totalTimeLogged_d'] = ' jours, ';
$txt['totalTimeLogged_h'] = ' heures et ';
