...
$txt['error_subs_missing'] = 'Incapable de trouver le fichier core/app/Subs.php. Veuillez vous assurer qu\'il a été transféré correctement, puis réessayez à nouveau.';
...
$txt['error_already_installed'] = 'L\'installateur a détecté que Wedge est déjà installé. Le processus s\'est arrêté, pour ne pas risquer d\'effacer par erreurs vos données existantes.<br><br>Si vous voulez remettre votre forum à zéro et écraser votre installation existante, y compris toutes ses données, effacez manuellement les tables de la base de données (ou modifiez son préfixe), effacez le fichier Settings.php et réessayez.';
