...
$txt['help_edit_disable_time'] = 'Nombre de minutes accordées à un utilisateur pour qu\'il puisse modifier ses messages. Mettre sur 0 pour désactiver. <br><br><em>Note: Cela n\'affectera pas l\'utilisateur qui a la permission de modifier les messages des autres.</em>';
...
$txt['help_correctExclamations'] = 'Cette option permet d\'empêcher les utilisateurs de mettre trop de ???? et de !!!! dans les titres de leurs sujets. SI !!!!!!!!!!1 -- ils seront automatiquement réduits à un seul ? ou !. SI !1';
