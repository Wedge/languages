...
$txt['maintain_optimize_info'] = 'This task allows you to optimise all tables. This will get rid of overhead, effectively making the tables smaller, but in some cases can have a slowdown effect on the forum.';
