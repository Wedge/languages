...
$txt['permissionhelp_manage_smileys'] = 'This allows access to the smiley centre. In the smiley center you can add, edit and remove smileys and smiley sets. If you\'ve enabled customized message icons you are also able to add and edit message icons with this permission.';
