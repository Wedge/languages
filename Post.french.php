...
$txt['media'] = 'Uploader un fichier média';
...
$txt['more_bbc'] = 'Plus (cache le reste du texte sur les sommaires de blogs, flux Atom et autres)';
...
$txt['shortcuts'] = 'Raccourcis clavier&nbsp;: [Alt]+[S] (Send) pour envoyer<br>le message, ou [Alt]+[P] pour le prévisualiser';
$txt['shortcuts_firefox'] = 'Raccourcis clavier&nbsp;: [Shift]+[Alt]+[S] (Submit) pour envoyer<br>le message, ou [Shift]+[Alt]+[P] pour le prévisualiser';
$txt['option'] = 'Option';
...
$txt['restricted_filename'] = 'Votre dossier a été appelé "%1$s" - nom de fichier réservé. Merci de le renommer.';
