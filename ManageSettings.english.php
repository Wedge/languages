...
$txt['setting_time_offset_subtext'] = '(added to the member specific option.)';
...
$txt['setting_warning_watch_subtext'] = 'The user warning level after which a user watch is put in place - 0 to disable.';
$txt['setting_warning_moderate'] = 'Warning level for post moderation';
$txt['setting_warning_moderate_subtext'] = 'The user warning level after which a user has all posts moderated - 0 to disable.';
$txt['setting_warning_mute'] = 'Warning level for user muting';
$txt['setting_warning_mute_subtext'] = 'The user warning level after which a user cannot post any further - 0 to disable.';
$txt['setting_user_limit'] = 'Maximum user warning points per day';
$txt['setting_user_limit_subtext'] = 'This value is the maximum amount of warning points a single moderator can assign to a user in a 24 hour period - 0 for no limit.';
$txt['setting_warning_decrement'] = 'Warning points to decrement from users every 24 hours';
$txt['setting_warning_decrement_subtext'] = 'Only applies to users not warned within last 24 hours - set to 0 to disable.';
...
$txt['language_edit_search_themes'] = 'Include themes?';
...
$txt['language_edit_no_themes_desc'] = 'There are no editable language files for any themes.';
