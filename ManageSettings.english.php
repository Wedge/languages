...
$txt['enableCompressedData'] = 'Enable compressed CSS/JS';
$txt['obfuscate_js'] = 'Obfuscate Javascript filenames';
...
$txt['pruneBanLog'] = 'Remove ban hit log entries older than<dfn>(0 to disable)</dfn>';
...
$txt['core_settings_item_cp_desc'] = 'This enables you to hide standard profile fields, request profile fields at registration, and create custom fields for your forum.';
...
$txt['add_language_smf_found'] = 'The following languages were found. Click the install link next to the language you wish to install, you will then be taken to the add-on manager to install.';
...
$txt['languages_download_illegal_paths'] = 'Add-on contains illegal paths - please contact Simple Machines';
